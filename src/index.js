...
import { ButtonToolbar, DropdownItem, DropdownToggle, DropdownMenu, Dropdown } from 'reactstrap';
import './index.css';
...
class Box  extends React.Component {
  ...
  render() {
    return (
      <div className={this.props.boxClass} id={this.props.id} onClick={this.selectBox}></div>)
  }
}
    ...
    return (
      <div className="center">
        <ButtonToolbar>
          ...
          <Dropdown> Grid Size
            <DropdownToggle title="Grid Size" id="size-menu" onSelect={this.handleSelect} caret>
              <DropdownMenu>
  ...
  render() {
    return (
      <div>
        ...
        />
        <h2>Gererations: {this.state.generation}</h2>
      </div>
    );
  }
}
